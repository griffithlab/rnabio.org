...
- [RNA-seqlopedia](https://rnaseq.uoregon.edu/) (Includes a very comprehensive review of library construction concepts)
...
- [RNA Sequencing and Analysis - 2015 review](https://cshprotocols.cshlp.org/content/early/2015/04/11/pdb.top084970.abstract)
- [Comparative analysis of RNA sequencing methods](https://www.nature.com/nmeth/journal/v10/n7/full/nmeth.2483.html)
- [RNA-seq Data: Challenges in and Recommendations for Experimental Design and Analysis](https://onlinelibrary.wiley.com/doi/10.1002/0471142905.hg1113s83/full)
- [RNA Bioinformatics (a 25 chapter book)](https://link.springer.com/book/10.1007%2F978-1-4939-2291-8)
...
- [A comprehensive assessment of RNA-seq accuracy, reproducibility and information content by the Sequencing Quality Control Consortium (SEQC)](https://www.nature.com/nbt/journal/v32/n9/full/nbt.2957.html)
- [ENCODE RNA-seq Standards](https://github.com/griffithlab/rnabio.org/blob/master/assets/ResourceFiles/ENCODE_RNA-seq_standards_v1.0.pdf)
- [The RNA-seq blog - recent developments in RNA-seq technology and analysis](https://www.rna-seqblog.com/)
- [Proportionality: A Valid Alternative to Correlation for Relative Data](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4361748/)
...
- [A UNIX command cheat sheet](https://www.rain.org/~mkummel/unix.html)
- [A UNIX tutorial for beginners](https://www.ee.surrey.ac.uk/Teaching/Unix/)
- [A UNIX and Perl primer for biologists](https://korflab.ucdavis.edu/Unix_and_Perl/current.html)
- [A command-line bootcamp](https://korflab.ucdavis.edu/bootcamp.html)
...
- [A command-line linux tutorial in your browser](https://rik.smith-unna.com/command_line_bootcamp/)
...
- [Vim Adventures - a graphical game to help learn Vim](https://vim-adventures.com/)
- [Vim Graphical Cheat Sheets](https://www.viemu.com/a_vi_vim_graphical_cheat_sheet_tutorial.html)
- [Vi tutorial and advanced features](https://www.yolinux.com/TUTORIALS/LinuxTutorialAdvanced_vi.html)
...
- [The official R intro manual](https://cran.r-project.org/doc/manuals/r-release/R-intro.html)
- [Rseek, a search engine for R related questions](https://rseek.org/)
...
- [Swirl - Learn R, in R.](https://www.swirlstats.com/)
- [Quick and Dirty Guide to R](https://ww2.coastal.edu/kingw/statistics/R-tutorials/text/quick&dirty_R.txt)
...
- [Description of the Human Brain Reference (HBR) sample used to generate the tutorial data](https://github.com/griffithlab/rnabio.org/blob/master/assets/ResourceFiles/HBR.pdf)
- [Description of the Universal Human Reference (UHR) sample used to generate the tutorial data](https://github.com/griffithlab/rnabio.org/blob/master/assets/ResourceFiles/UHR.pdf)

#### 6. Resources to help find RNA-seq Data Sets
- [GEO: The Gene Expression Omnibus](https://www.ncbi.nlm.nih.gov/geo/)
- [GXA: the EBI Expression Atlas](https://www.ebi.ac.uk/gxa/home/)
- [SHARQ: Search public, human, RNA-seq experiments by cell, tissue type, and other features](https://www.cs.cmu.edu/~ckingsf/sharq/index.html)
...
- [BioLinux - An Ubuntu Linux system with many Bioinformatics tools pre-installed](https://environmentalomics.org/bio-linux/)
- [CloudBioLinux - A cloud ready version of BioLinux](https://cloudbiolinux.org/)
- [sandbox.io - Interactive bioinformatics tutorials](https://sandbox.bio/)

#### 8. Getting More Help
- [Biostars - A forum for the bioinformatics community](https://www.biostars.org/)
- [SEQanswers - A forum for the next generation sequencing community](https://seqanswers.com/)
