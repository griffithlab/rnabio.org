...
Dylan
bcftools - should be installed already
bedtools - should be installed already
bwa - should be installed already
freebayes - should be installed already
samtools - should be installed already
tabix - should be installed already
vcflib - installed
...
bcftools - should be installed already
bwa - should be installed already
slivar - should be installed already
VEP (sorry)
conda with python (from Jason Williams) - installed
install jupyter
IGV - installed on Macs already
...
Chris
MACS (install version 2.x, usually through pip I think - don't get the 3.0beta) - installed
https://github.com/macs3-project/MACS

samtools - installed 
awk  (prob already there) - installed

cgpbigwig
 
Rstudio - need to install this below
- ggplot2
- dplyr
- tidyverse
