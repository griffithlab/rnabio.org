...
tar -zxvf kallisto_linux-v0.44.1.tar.gz
...
```bash
R
install.packages(c("devtools","dplyr","gplots","ggplot2","Seurat","sctransform","RColorBrewer","ggthemes","cowplot","data.table","Rtsne"),repos="http://cran.us.r-project.org")
quit(save="no")
```
...
BiocManager::install(c("genefilter","ballgown","edgeR","GenomicRanges","rhdf5","biomaRt","scran"))
quit(save="no")
```
...
* cshl-seqtech-2020 (ami-099a41cace28b3183; N. Virginia)
