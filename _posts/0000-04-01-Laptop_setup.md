...
1) Install R which can be downloaded from [CRAN](https://probability.ca/cran/).

2) Download and install the most recent version of [R Studio desktop](https://www.rstudio.com/).  If prompted to install git, select yes.
...
5) Install the Integrative Genomics Viewer (IGV). Follow the [IGV Install Instructions](https://software.broadinstitute.org/software/igv/download) for your operating system.

6) Install an SSH client if needed. Mac users already have a command line ssh program that can be run from the terminal. For Windows users, you may use PowerShell or download [PuTTY](https://www.chiark.greenend.org.uk/~sgtatham/putty/download.html).  
...
10) If relevant to course version, download all example scRNAseq files for a loupe demonstration from our [course server](https://genomedata.org/rnaseq-tutorial/scrna/).
