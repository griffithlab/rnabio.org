...
Alternatively from the command line you could launch such an instance as follows (you should probably personalize the name used in two places of this command):
```bash
