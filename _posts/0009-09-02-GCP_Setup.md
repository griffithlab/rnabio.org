...
4. `CHANGE` the `Boot disk`. Switch to `CUSTOM IMAGES`. Enter Image name: `rnabio-course-2023-v2`
...
Alternatively from the command line you could launch such an instance as follows (you should probably personalize the `malachi-course-2023` name used in two places of this command):
```bash
