...
```bash
cd ~/bin
wget https://ccb.jhu.edu/software/stringtie/dl/stringtie-2.1.6.tar.gz
...
```bash
R
install.packages(c("devtools","dplyr","gplots","ggplot2","Seurat","sctransform","RColorBrewer","ggthemes","cowplot","data.table","Rtsne","gridExtra","UpSetR"),repos="https://cran.us.r-project.org")
quit(save="no")
```
