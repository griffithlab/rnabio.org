...
Welcome to the lab for Genome Visualization! This lab will introduce you to the [Integrative Genomics Viewer](https://www.broadinstitute.org/igv/), one of the most popular visualization tools for High Throughput Sequencing (HTS) data.
...
#### Compatibility
This tutorial was most recently updated for IGV v2.16.2, which is available on the [IGV Download page](https://software.broadinstitute.org/software/igv/download). It is recommended that you use this version. Most other recent versions will work but their may be slight differences.
...
We will be visualizing read alignments using [IGV](https://www.broadinstitute.org/igv/), a popular visualization tool for HTS data.
