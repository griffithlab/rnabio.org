...
If you would like a refresher on alignment, we have created an [alignment mini lecture](/assets/lectures/cbw-cshl/2019/mini/RNASeq_MiniLecture_08_01_Alignment.pdf).

We have also provided a mini lectures describing the differences between [alignment, assembly, and pseudoalignment](/assets/lectures/cbw-cshl/2019/RNASeq_MiniLecture_08_02_Alignment_vs_Assembly_vs_Kmer.pdf) and describing [sam, bam, and bed file formats](/assets/lectures/cbw-cshl/2019/RNASeq_MiniLecture_08_03_SAM_BAM_BED.pdf).
